              ...
              <div className="card-block">
                ...
                <form onSubmit={this.handleFormSubmit}>
                  <div className="form-group">
                    <textarea onChange={this.handleCommentTextChange} className="form-control" name="comment"  rows="3" type="text" value={this.state.commentText}/>
                  </div>
                  <div className="form-group">
                    <input onChange={this.handleNameChange} className="form-control col-md-3" name="name"  type="text" value={this.state.name}/>
                  </div>
